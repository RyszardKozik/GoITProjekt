...
def suggest_closest_command(contact_action, available_commands):
    closest_command = min(available_commands, key=lambda x: abs(ord(x) - ord(contact_action)))
        ...
        if action == 'z':
            while True:
                ...
                if contact_action == 'd':
                    ...
                    closest_command = suggest_closest_command(contact_action, available_commands)
